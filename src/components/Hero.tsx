...
export default function Hero() {
    return (
        <div id="#inicio" className="w-full flex md:flex-row justify-around items-center mt-20 flex-col-reverse">
            <div className="flex flex-col space-y-2 text-center md:text-justify">
            ...
            <img className="rounded-full border-4 border-blue-500" src={"https://avatars.githubusercontent.com/u/131329633?v=4"} alt="Foto de perfil Buys Code"/>
        </div>
    )
}