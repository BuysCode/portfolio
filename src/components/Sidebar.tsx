...
export default function Sidebar({ isOpen, toggleSidebar }: SidebarProps) {
    return (
            isOpen && (
            <div className={`fixed top-0 left-0 h-full w-64 bg-gray-950 text-white transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} z-50 md:hidden block transition-transform duration-300 ease-in-out`}>
                <div className="p-4">
